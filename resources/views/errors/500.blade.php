...
<head>
    ...
    <title>500 — Erreur serveur | ArtisanHub</title>
...
<body>
    ...
    <div class="flex-grow-1 d-flex align-items-center justify-content-center py-5">
        <div class="text-center px-4" style="max-width:520px">
            ...
            <div style="font-size:2.5rem;margin:-20px 0 16px">⚙️</div>
            <h1 style="font-size:1.8rem;margin-bottom:12px">Erreur serveur</h1>
            <p class="text-muted mb-4" style="font-size:1rem;line-height:1.7">
                Une erreur s'est produite. Notre équipe a été notifiée. Réessayez dans quelques instants.
            </p>
